...
std::string Film::informatii() const {
    if (varsta_necesara == 18)
        return "Acest film este dedicat strict pentru adulti!"
               "\n-------------------------------------------------------------------";
    else if (varsta_necesara >= 14)
        return "Acest film poate fi vizionat numai cu acordul parintilor!"
               "\n-------------------------------------------------------------------";
    else
        return "Acest film este pentru copii!!"
               "\n-------------------------------------------------------------------";
}//CATEGORII DE VARSTA
